...
namespace TMPro
{
    public class TMP_TextEventHandler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        /// <summary>
        ///     Result delegate triggered when pointer is over a character.
        /// </summary>
        ...
        /// <summary>
        ///     Result delegate triggered when pointer is over a sprite.
        /// </summary>
        ...
        /// <summary>
        ///     Result delegate triggered when pointer is over a word.
        /// </summary>
        ...
        /// <summary>
        ///     Result delegate triggered when pointer is over a line.
        /// </summary>
        ...
        /// <summary>
        ///     Result delegate triggered when pointer is over a link.
        /// </summary>
        ...
        private void LateUpdate()
        {
                    ...
                    m_Camera))
            {
                ...
                if (charIndex != -1 && charIndex != m_lastCharIndex)
                {
                    ...
                    // Send result to any result listeners depending on whether it is a character or sprite.
                ...
                if (wordIndex != -1 && wordIndex != m_lastWordIndex)
                {
                    ...
                    // Send the result to any listeners.
