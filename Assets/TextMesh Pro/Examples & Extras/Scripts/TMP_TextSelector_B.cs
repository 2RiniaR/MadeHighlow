...
namespace TMPro.Examples
{
        ...
        IPointerUpHandler
    {
        ...
        private void LateUpdate()
        {
            if (isHoveringObject)
            {
                ...
                if (linkIndex != -1 && linkIndex != m_selectedLink)
                {
                    ...
                    // Debug.Log("Link ItemID: \"" + linkInfo.GetLinkID() + "\"   Link Text: \"" + linkInfo.GetLinkText() + "\""); // Example of how to retrieve the Link ItemID and Link Text.
                    ...
                    switch (linkInfo.GetLinkID())
                    {
                        case "id_01": // 100041637: // id_01
                            ...
                            m_TextPopup_TMPComponent.text = k_LinkText + " ItemID 01";
                            break;
                        case "id_02": // 100041638: // id_02
                            m_TextPopup_RectTransform.position = worldPointInRectangle;
                            m_TextPopup_RectTransform.gameObject.SetActive(true);
                            m_TextPopup_TMPComponent.text = k_LinkText + " ItemID 02";
                            break;
                    }
                }
        ...
        {
            // Subscribe to result fired when text object has been regenerated.
            TMPro_EventManager.TEXT_CHANGED_EVENT.Add(ON_TEXT_CHANGED);
        }

        private void OnDisable()
        {
            // UnSubscribe to result fired when text object has been regenerated.
