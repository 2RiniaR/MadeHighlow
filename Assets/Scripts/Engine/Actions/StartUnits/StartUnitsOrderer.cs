...
namespace RineaR.MadeHighlow
{
    ...
    /// </summary>
    public record StartUnitsOrderer
    {
        /// <summary>
        ///     行動順を決定する命令
        /// </summary>
        public ValueObjectList<UnitOperation> Operations { get; init; } = ValueObjectList<UnitOperation>.Empty;

        /// <summary>
        ///     命令の実行順を決定する
        /// </summary>
        [NotNull]
        public ValueObjectList<UnitOperation> Resolve([NotNull] IActionContext context)
        {
            return Operations.Sort((unit1, unit2) => Compare(unit1, unit2, context));
        }
        ...
        /// </returns>
        private int Compare(
            [NotNull] UnitOperation operation1,
            [NotNull] UnitOperation operation2,
        ...
        )
        {
            ...
            var quickness1 = card1.Command.Quickness;
            var quickness2 = card2.Command.Quickness;
